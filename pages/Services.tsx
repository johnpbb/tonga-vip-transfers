      ...
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
           ...
           <div className="order-1 lg:order-2">
             <img src="https://picsum.photos/600/400?grayscale" alt="Airport Transfer Tonga" className="rounded-xl shadow-2xl" />
           </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
           <div>
             <img src="https://picsum.photos/600/400?blur=1" alt="Tonga Island Tour" className="rounded-xl shadow-2xl" />
           </div>
           <div>
